    ...
    <div class="row">
      ...
      <div class="mb-3 col-md-4">
        ...
        <small class="text-danger">
          <i class="bx bx-info-circle"></i> Kosongkan jika belum mengetahui
          ukuran buku
        </small>
      </div>
      <div class="mb-3 col-md-4">
      ...
      <div class="col-md-6 mb-3">
        <label for="naskah" class="form-label"
          ><sup class="text-danger">*</sup>File Naskah:
        </label>
        <input
          type="file"
          id="naskah"
      ...
      <div class="col-md-3 mb-3">
        ...
        />
        <small class="text-danger"
          ><i class="bx bx-error"></i> Kosongkan jika belum ada desainer</small
        >
      </div>
      <div class="col-md-3 mb-3">
        ...
        />
        <small class="text-danger"
          ><i class="bx bx-error"></i> Kosongkan jika belum ada layouter</small
        >
      </div>
      <div class="col-md-3 mb-3">
        ...
        >
          <div class="modal-body">
            <p>
              ...
              PERPUSNAS mewajibkan anda mengisi SURAT PERNYATAAN KEASLIAN KARYA,
              Silahkan download surat pernyataan dengan menekan tombol dibawah
              ini.
            </p>
            <p class="text-danger">
      ...
      <div
        class="col-md-6 mb-3"
        v-if="tipe_kepenulisan !== 'naskah_pribadi' && tipe_kepenulisan !== ''"
      >
...
const { value: surat_pernyataan_keaslian } = useField<File | undefined>(
  "surat_pernyataan_keaslian"
);
...
const { postResourceFormData, postResource, getResource } = useApi();
